        ...
        try {
            ...
            foreach ($data as $record) {
                ...
                $comprehensiveData = [
                    ...
                    'ID 1: IssueDate' => !empty($record->ID1IssueDate) ? date('Y-m-d', strtotime($record->ID1IssueDate)) : '',
                    'ID 1: IssueCountry' => $id1IssueCountry,
                    'ID 1: ExpiryDate' => !empty($record->ID1ExpiryDate) ? date('Y-m-d', strtotime($record->ID1ExpiryDate)) : '',
                    'ID 1: Issued By' => $record->ID1IssuedBy ?? '',
                    'ID 2: Type' => $record->ID2TypeCode ?? '',
                    'ID 2: Number' => $record->ID2Number ?? '',
                    'ID 2: IssueDate' => !empty($record->ID2IssueDate) ? date('Y-m-d', strtotime($record->ID2IssueDate)) : '',
